...
class RegionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create region" do
    assert_difference('Region.count') do
      post regions_url, params: { region: { info: @region.info, name: @region.name, website: @region.website } }
    end
  ...
  test "should update region" do
    patch region_url(@region), params: { region: { info: @region.info, name: @region.name, website: @region.website } }
